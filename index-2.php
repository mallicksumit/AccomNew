...
<!-- Mirrored from triper.dexignlab.com/xhtml/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Oct 2018 05:58:46 GMT -->
<head>
		<meta charset="utf-8">
...
<div class="page-wraper">
				...
				<ul>  <!-- SLIDE  -->
					<li data-index="rs-100" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/main-slider/slide1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						...
						<div class="tp-caption tp-resizeme d-md-block d-none text-white" 
							...
							data-paddingbottom="[0,0,0,0]"
							data-paddingleft="[0,0,0,0]"
							style="z-index: 7; white-space: nowrap; font-size: 55px; line-height: 60px; font-weight: 800; letter-spacing: 0px; font-family:Signika;">Amazing Tours And Fun</div>
						<div class="tp-caption tp-resizeme d-md-block d-none text-white" 
							...
							data-paddingbottom="[0,0,0,0]"
							data-paddingleft="[0,0,0,0]"
							style="z-index: 7; white-space: nowrap; font-size: 55px; line-height: 60px; font-weight: 800; letter-spacing: 0px; font-family:Signika;">Adventures Waiting For You</div>
						<!-- LAYER NR. 2 -->
						<div class="tp-caption   tp-resizeme d-md-block d-none" 
							...
							data-paddingbottom="[0,0,0,0]"
							data-paddingleft="[0,0,0,0]"
							style="z-index: 6; font-size: 18px; line-height: 28px; font-weight: 500; color: #fff; white-space: inherit; font-family:Nunito;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and..
						</div>	
						<!-- LAYER NR. 6 -->
						<div class="tp-caption tp-resizeme d-md-block d-none" 
				...
				<div class="row" id="masonry">
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html">Kolkata</a></h4>
								...
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Kolkata</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html"> Bangalore</a></h4>
								<p>We invite you to experience here with your family, definitely you are filled with lasting memories and feel awesome.Make Yourself at Home.</p>
								
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Bangalore</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html">Mumbai</a></h4>
								<p>We invite you to experience here with your family, definitely you are filled with lasting memories and feel awesome.Make Yourself at home.</p>
								
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Mumbai</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html">Goa</a></h4>
								<p>We invite you to experience here with your family, definitely you are filled with lasting memories and feel awesome.</p>
								
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Goa</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html">Chennai</a></h4>
								<p>We invite you to experience here with your family, definitely you are filled with lasting memories and feel awesome.</p>
								
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Chennai</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 m-b30 card-container">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a20 border-1 text-center">
								<h4 class="dlab-title m-t0"><a href="booking-details.html">Kota</a></h4>
								<p>We invite you to experience here with your family, definitely you are filled with lasting memories and feel awesome. </p>
								
								<div class="tr-btn-info">
									<a href="booking-details.html" class="site-button radius-no"><i class="fa fa-location-arrow" aria-hidden="true"></i> Kota</a> 
									<a href="booking-details.html" class="site-button bg-primary-dark radius-no"><i class="fa fa-info-circle" aria-hidden="true"></i>  Relax </a> 
								</div>
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-12">
						<div class="add-area">
							<h3>Rs 4000 for each person per month</h3>
							...
							<a href="#" class="site-button white">See Promotion</a>
						</div>
					</div>
				...
				<div class="row packages">
					<div class="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
						<div class="dlab-box">
							<div class="dlab-media"> 
								<a href="#"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img4.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a15 border-1">
								<h4 class="dlab-title m-t0"><a href="packages.html">At Howrah</a></h4>
								<span class="location">College More</span>
								<div class="package-content">
									...
									<div class="clearfix">
										...
										<a href="booking-details.html" class="site-button pull-right">View details</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
						<div class="dlab-box">
							...
							<div class="dlab-info p-a15 border-1">
								<h4 class="dlab-title m-t0"><a href="packages.html">At Bangalore</a></h4>
					...
					<div class="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
						<div class="dlab-box">
							<div class="dlab-media"> 
								<a href="#"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img5.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a15 border-1">
								<h4 class="dlab-title m-t0"><a href="packages.html">At Gujrat</a></h4>
					...
					<div class="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
						<div class="dlab-box">
							<div class="dlab-media"> 
								<a href="#"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img6.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a15 border-1">
								<h4 class="dlab-title m-t0"><a href="packages.html">At Goa</a></h4>
    ...
    <footer class="site-footer">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                        <div class="widget widget_gallery">
                            ...
                            <ul class="clearfix mfp-gallery">
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img1.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img1.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img2.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img2.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img3.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img3.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img4.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img4.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img5.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img5.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img6.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img6.jpg" alt=""></a> </li>		
								<li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img7.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img7.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img8.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img8.jpg" alt=""></a> </li>
                                <li class="img-effect2"><a class="mfp-link" href="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img9.jpg" title="Title Come Here"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/gallery/img9.jpg" alt=""></a> </li>	
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 text-left"> <span>Copyright © 2018 Accom Now</span> </div>
                    <div class="col-lg-6 col-md-6 text-right "><span> Design With <i class="fa fa-heart text-primary heart"></i> By Accom Now </span> </div>
                </div>
            </div>
        </div>
    </footer>
