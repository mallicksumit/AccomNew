...
if (isset($_POST['login_user'])) {
    $email = $_POST['dzName_email'];
    $upass = $_POST['dzName_password'];
	...
	// echo " another one is : ",$row['password'];
...
<!-- Mirrored from triper.dexignlab.com/xhtml/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Oct 2018 05:58:45 GMT -->
<head>
		<meta charset="utf-8">
	...
	<!-- PAGE TITLE HERE --><title> Accom Now:Login</title>
            ...
            <div class="main-bar clearfix onepage">
                <div class="container clearfix">
                    ...
                    <div class="logo-header mostion">
						<a href="index.php"><img src="../../s3.ap-south-1.amazonaws.com/dlab-html/triper/xhtml/images/logo1.png" alt=""></a>
					</div>
                    <!-- nav toggle button -->
						...
						<div class="p-a30 border-1 seth">
							<div class="tab-content nav">
								<form id="login" class="tab-pane active col-12 p-a0 " method="POST" >
									...
									<div class="text-left">
										<button class="site-button m-r5 button-lg radius-no" name="login_user">login</button>
...
<!-- Mirrored from triper.dexignlab.com/xhtml/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Oct 2018 05:58:46 GMT -->
</html>
